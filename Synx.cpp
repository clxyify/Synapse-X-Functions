//hey there you prob got this from clxyify!
//note: i deleted tons of includes, so you might get tons of errors
...
#define LockTable() *(BYTE*)(RL.ToPointer(-1) + RT_LOCKED) = TRUE
	...
	{
		syn::HWID = std::move(HWID);//you need mostly calls for tis.
	}
}
